...
@interface YcVideoPlayerPlugin () <FLTVideoPlayerApi>
...
@implementation YcVideoPlayerPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    YcVideoPlayerPlugin* instance = [[YcVideoPlayerPlugin alloc] initWithRegistrar:registrar];
